...
app.use(
  cors({
    origin: ["http://localhost:3000", "http://127.0.0.1:3000", 'https://campus-bites-c7pe.vercel.app', 'https://campus-bites-eta.vercel.app', 'https://www.campusbites.in'], // Allow frontend
